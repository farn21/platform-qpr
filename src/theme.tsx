...
const theme: Theme = {
  ...
  text: {
    ...
    tertiary: "#fff",
    highlighted: "#fff",
    headerFontFamily: "Rubik-Regular,sans-serif",
    bodyFontFamily: "Rubik-Light,sans-serif",
    navBarFontFamily: "Rubik-Regular,sans-serif",
    textTransform: "uppercase",
    titleColor: "#aaa",
    titleFontFamily: "Rubik-Regular,sans-serif",
  },
  map: {
